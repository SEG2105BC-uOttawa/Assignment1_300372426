...
/**
 * The Professor class represents a professor, extending the Instructor class
 * and implementing the Teacher interface.
...
public class Professor extends Instructor {
	...
	/**
	 * Assigns a course to the professor if the maximum number of courses is not
	 * exceeded.
	 * 
