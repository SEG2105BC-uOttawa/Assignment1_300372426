...
public class Course {
    ...
    // The Teacher assistant of the course
    ...
    /**
     * Gets the teaching assistant of the course.
     *
    ...
    /**
     * Sets the teaching assistant of the course.
     *
     * @param teachingAssistant the teaching assistant to set
     */
    ...
    /**
     * Gets the name of the teaching assistant of the course.
     *
     * @return the teaching assistant's full name or "Not yet assigned" if no
    ...
    public String toString() {
        return "Course information:\n"
                ...
                + "\tCourse T.A: " + getTeachingAssistantName() + "\n"
