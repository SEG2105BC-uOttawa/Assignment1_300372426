...
/**
 * The Main class is the entry point for the university management system
 * application.
 * It initializes the CommandLineUI to start accepting user input, initiates the
 * UniversityManagementSystem, and creates the data store.
 * 
