...
public abstract class Instructor extends Employee {
     ...
     * Subclasses must implement this method to specify constraints on course
     * assignment.
     *
    ...
    public String getCoursesTable() {
        // We will generate a table that corresponds to the list of courses taught by
        // this instructor.
        ...
        // The length of the array corresponds to the number of elements in the courses
        // list,
